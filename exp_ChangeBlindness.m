    ...
    function [text]=GetText(nInstruct)
        if nInstruct == 0%Eyetracking calibration
            ...
            text = ['Wir kalibrieren jetzt den Eye-Tracker.\n\n' ...
                ...
                'Sollten Sie Ihre Position noch ver?ndern m?ssen, tun Sie dies am besten jetzt.\n'...
                'Die beste Position ist meist die bequemste.\n\n'...
                'Bitte dr?cken Sie jetzt die Leertaste, \n' ...
        ...
        elseif nInstruct == 2;%AskDetectionSelectable
            text = ['Sie sehen nun verschiedene Bilder.\n'...
                'Hin und wieder ?ndert sich das Bild, d.h. ein Objekt darin verschwindet\n'...
                'bzw. taucht wieder auf.\n'...
                '\n'...
                'Finden Sie die Ver?nderung?\n\n'...
                'Wenn Sie die Ver?nderung entdeckt haben, dr?cken Sie die Leertaste! \n'...
                'Bitte zum Starten die Leertaste dr?cken.\n'...
                ];
        elseif nInstruct == 3;%AskDetectionSelectable
            text = ['Alles klar?\n'...
                '\n'...
                'Wenn Sie noch Fragen haben, k?nnen Sie diese jetzt gerne stellen.\n\n'...
                '\n'...
                'Ansonsten zum Starten bitte die Leertaste dr?cken.\n'...
                ];
        elseif nInstruct == 4
            text = ['Das wars!\n'...
                '\n'...
        ...
        elseif nInstruct == 801;%AskDetectionSelectable
            text = ['Sie sehen nun eine ?bersicht der verschiedenen Gesichter.\n'...
                ...
                'Bitte dr?cken Sie zum Start die Leertaste und\n' ...
        ...
        elseif nInstruct == 9%
            ...
            text = ['Bitte geben Sie an, ob die Reizst?rke des folgenden Schocks\n f?r Sie ertr?glich ist.\n'...
                '\n'...
                'Dr?cken Sie bitte die Leertaste um den Reiz zu bekommen.\n'...
                ];
        ...
        elseif nInstruct == 11%this is the rating question
            text = ['Wie wahrscheinlich ist es, bei dem gerade gesehenen Gesicht \n'...
                ...
                'und best?tigen Sie Ihre Einsch?tzung mit der mit der Leertaste'...
                ];
