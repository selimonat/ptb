...
%                 Eyelink('ImageTransfer',p.stim.files24(stim_id,:),p.ptb.imrect(1),p.ptb.imrect(2),p.stim.width,p.stim.height,p.ptb.imrect(1),p.ptb.imrect(2),0);
    ...
    function SetParams
        ...
        p.path.baselocation           = 'C:\Users\onat\Documents\Experiments\NoS';
    ...
    function [text]=GetText(nInstruct)
        if nInstruct == 0%Eyetracking calibration
            ...
            text = ['Wir kalibrieren jetzt den Eye-Tracker.\n\n' ...
                ...
                'Sollten Sie Ihre Position noch verändern müssen, tun Sie dies am besten jetzt.\n'...
        ...
        elseif nInstruct == 2;%AskDetectionSelectable
            text = ['Sie sehen nun verschiedene Bilder.\n'...
                'Hin und wieder ändert sich das Bild, d.h. ein Objekt darin verschwindet\n'...
                'bzw. taucht wieder auf.\n'...
                '\n'...
                'Finden Sie die Veränderung?\n\n'...
                'Wenn Sie die Veränderung entdeckt haben, drücken Sie die Leertaste! \n'...
                'Bitte zum Starten die Leertaste drücken.\n'...
                ];
        elseif nInstruct == 3;%AskDetectionSelectable
            text = ['Alles klar?\n'...
                '\n'...
                'Wenn Sie noch Fragen haben, können Sie diese jetzt gerne stellen.\n\n'...
                '\n'...
                'Ansonsten zum Starten bitte die Leertaste drücken.\n'...
                ];
        elseif nInstruct == 4
            text = ['Das wars!\n'...
                '\n'...
    ...
    function SetPTB
        ...
        p.ptb.screenNumber          =  2;%max(screens);%the maximum is the second monitor
