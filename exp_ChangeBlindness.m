...
%         mkdir(p.path.subject);
    ...
    function [text]=GetText(nInstruct)
        ...
        elseif nInstruct == 1%Training phase.
            text = ['Wir werden nun als erstes einen ' sprintf('\x00fc') 'bungsdurchgang machen,\n' ...
        ...
        elseif nInstruct == 2;%AskDetectionSelectable
            text = ['Sie sehen nun verschiedene Bilder.\n'...
                'Hin und wieder ' sprintf('\x00e4') 'ndert sich das Bild, d.h. ein Objekt darin verschwindet\n'...
                'bzw. taucht wieder auf.\n'...
                '\n'...
                'Finden Sie die Ver' sprintf('\x00e4') 'nderung?\n\n'...
                'Wenn Sie die Ver' sprintf('\x00e4') 'nderung entdeckt haben, dr\u00fccken Sie die Leertaste! \n'...
                'Bitte zum Starten die Leertaste dr' sprintf('\x00fc') 'cken.\n'...
                ];
