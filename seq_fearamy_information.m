function [out]=seq_fearamy_information(s,varargin)
%[out]=seq_fearamy_information(s,varargin)
%
%
%   Adapted from seq_feargen_information.m. Assumes the last and last -1 are UCS
%   and oddballs blocks, respectively. As this deals with micro-blocks
%   rather than trials, the null trials are not present in this level, this
%   is basically the adaptation from feargen to fearamy.
%
%   OUT contains all the information. Use
