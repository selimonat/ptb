function [p]=exp_PMF_ForAll(subject,phase,csp)
...
fixjump         = 1; %fixation cross starts at eyes and jumps to mouth 
...
movefile(p.path.subject,p.path.finalsubject);
    ...
    function SetParams
        ...
        elseif strcmp(p.hostname,'etpc')
            ...
            p.path.baselocation       = 'C:\Users\...\Documents\Experiments\';
        end
        ...
        interval = 22.5;
        maxdegree = 180;
        maxtrials = 100; % this will be exceeded, if addzeros > 0
        addzeros  = 0;
